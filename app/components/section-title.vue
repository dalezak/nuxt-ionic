...
<!--
  section-title — page-level title / hero heading. Used once per page
  ...
  parts, emphasis) without changing the component. Styling lives here
  so the suite (best-self, love-well, any-learn) picks up changes in
  one place.
-->

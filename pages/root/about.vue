<template>
  <ion-page>
    ...
    <ion-content class="ion-padding">
      <ion-card>
        <ion-card-header>
          <ion-card-title>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</ion-card-title>
